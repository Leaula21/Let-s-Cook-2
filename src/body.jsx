  ...
  return (
    <div className="container my-12 mx-auto px-4 md:px-12">
      <div className="flex flex-wrap -mx-1 lg:-mx-4">
        {recettes.map((item) => (
          <div key={item.id} className="w-full md:w-1/2 lg:w-1/3 px-1 lg:px-4 mb-4">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-4">
                ...
                <div className="flex items-center mb-2"> {/* Container for aligning author, category, and star */}
                  ...
                  <span className="bg-red-100 text-red-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-red-900 dark:text-red-300">{item.category}</span>
                </div>
